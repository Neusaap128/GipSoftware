...
public static class PoolManager
{
    ...
    /// <summary>
    /// returns whether there is a pool with the given key
    /// </summary>
    /// <param name="poolObject">Reference Object</param>
    /// <returns></returns>
    public static bool DoesPoolExist(PoolObject poolObject){
        return pools.ContainsKey(poolObject);
    }
