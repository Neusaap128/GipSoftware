...
namespace Asteroids{
    ...
    public class GameManager : MonoBehaviour{
        ...
        void Start(){
            instance = this;
            PoolManager.CreatePool(bullet, 10, transform);
        ...
        void SpawnAsteroid(){
            ...
            Vector3 rot = new Vector3(0, 0, Vector3.Angle(Vector3.up, Vector3.zero - pos) + Random.Range(-80, 80));

            PoolManager.RespawnObject(asteroid1, pos, rot);
        }
